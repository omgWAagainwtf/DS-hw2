// $ANTLR 3.5.2 test1.g 2017-04-06 20:35:57
...
public class test1 extends Lexer {
	...
	public final void mDEC_NUM() throws RecognitionException {
		try {
			int _type = DEC_NUM;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// test1.g:51:9: ( ( '0' | ( '1' .. '9' ) ( DIGIT )* ) )
			// test1.g:51:11: ( '0' | ( '1' .. '9' ) ( DIGIT )* )
			{
			// test1.g:51:11: ( '0' | ( '1' .. '9' ) ( DIGIT )* )
			int alt2=2;
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// test1.g:53:4: ( ( LETTER ) ( LETTER | DIGIT )* )
			// test1.g:53:6: ( LETTER ) ( LETTER | DIGIT )*
			{
	...
	public final void mFLOAT_NUM() throws RecognitionException {
		try {
			int _type = FLOAT_NUM;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// test1.g:55:10: ( FLOAT_NUM1 | FLOAT_NUM2 | FLOAT_NUM3 )
			int alt4=3;
			alt4 = dfa4.predict(input);
			switch (alt4) {
				case 1 :
					// test1.g:55:12: FLOAT_NUM1
					{
					mFLOAT_NUM1(); 
	...
	public final void mFLOAT_NUM1() throws RecognitionException {
		try {
			// test1.g:56:20: ( ( DIGIT )+ '.' ( DIGIT )* )
			// test1.g:56:22: ( DIGIT )+ '.' ( DIGIT )*
			{
			// test1.g:56:22: ( DIGIT )+
			int cnt5=0;
			loop5:
	...
	public final void mCOMMENT2() throws RecognitionException {
		try {
			int _type = COMMENT2;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// test1.g:63:10: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// test1.g:63:12: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// test1.g:63:17: ( options {greedy=false; } : . )*
			loop10:
			while (true) {
				int alt10=2;
